...
- Suspended processes (Ctrl-Z, or a background job touching the terminal) are labelled as such — a caught terminate signal stays pending until they resume, so the engine wakes them up right after sending one
