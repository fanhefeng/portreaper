...
const zh = {
  ...
  // ---- 应用内更新（footer 入口 + UpdateModal；状态机见 src/updater.ts）----
  "update.check": "检查更新",
  "update.checking": "检查更新中…",
  "update.upToDate": "已是最新版本",
  "update.checkFailed": "检查更新失败",
  "update.badge": "新版本 v{version}",
  "update.restartBadge": "重启以完成更新",
  "update.title": "发现新版本",
  "update.installingTitle": "正在更新",
  "update.installedTitle": "更新已就绪",
  "update.failedTitle": "更新失败",
  "update.versionLine": "v{current} → v{next}",
  "update.downloading": "下载中… {pct}%",
  "update.downloadingNoTotal": "下载中… 已接收 {mb} MB",
  "update.installing": "下载完成，正在安装…",
  "update.installedBody": "新版本已安装完成，重启应用后生效。",
  "update.failedBody": "{err}",
  "update.releasePage": "查看发布说明",
  "update.later": "稍后",
...
const en: Record<I18nKey, string> = {
  ...
  "update.badge": "Update v{version}",
  "update.restartBadge": "Restart to finish update",
  "update.title": "Update available",
  "update.installingTitle": "Updating",
  "update.installedTitle": "Update ready",
  "update.failedTitle": "Update failed",
  "update.versionLine": "v{current} → v{next}",
  "update.downloading": "Downloading… {pct}%",
  "update.downloadingNoTotal": "Downloading… {mb} MB received",
  "update.installing": "Downloaded, installing…",
  "update.installedBody": "The new version is installed; restart the app to finish.",
  "update.failedBody": "{err}",
  "update.releasePage": "Release notes",
  "update.later": "Later",
